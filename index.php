    ...
    <body>
        ...
        <section class="section-steps" id="works">
            ...
            <div class="row">
                ...
                <div class="col span-1-of-2 steps-box">
                    ...
                    <a href="https://www.apple.com/ios/app-store/" target="_blank" class="btn-app"><img src="resources/img/download-app.svg" alt="App Store Button"></a>
                    <a href="https://play.google.com/store" target="_blank" class="btn-app"><img src="resources/img/download-app-android.png" alt="Play Store Button"></a>
                </div>
            </div>
        </section>
        ...
        <section class="section-cities" id="cities">
            ...
            <div class="row js--wp-3">
                <div class="col span-1-of-4 box">
                    <img src="resources/img/lisbon.min-3.jpg" alt="Lisbon">
                    <h3>Lisbon</h3>
                    ...
                    <div class="city-feature">
                        ...
                        <a href="https://twitter.com/login?lang=en" target="_blank">@omnifood_lx</a>
                    </div>
                </div>
                <div class="col span-1-of-4 box">
                    ...
                    <div class="city-feature">
                        <i class="ion-social-twitter icon-small"></i>
                        <a href="https://twitter.com/login?lang=en" target="_blank">@omnifood_sf</a>
                    </div>
                </div>
                <div class="col span-1-of-4 box">
                    ...
                    <div class="city-feature">
                        <i class="ion-social-twitter icon-small"></i>
                        <a href="https://twitter.com/login?lang=en" target="_blank">@omnifood_berlin</a>
                    </div>
                </div>
                <div class="col span-1-of-4 box">
                    ...
                    <div class="city-feature">
                        <i class="ion-social-twitter icon-small"></i>
                        <a href="https://twitter.com/login?lang=en" target="_blank">@omnifood_london</a>
                    </div>
                </div>
            </div>
...
I was looking for a quick and easy food delivery service in San Franciso. I tried a lot of them and ended up with Omnifood. Best food delivery service in the Bay Area. Keep up the great work!
        ...
        <footer>
            ...
            <div class="row">
                <p>
                    This webpage is created by MAHITH &nbsp;CHIGURUPATI. No copyrights &copy; here.
                    
                </p>
                <p>
                    Build with <i class="ion-ios-heart" style="color: #ea0000; padding: 0 3px;"></i> in the beautiful city of Nellore, India, March 2020.
                </p>
            </div>
        </footer>
